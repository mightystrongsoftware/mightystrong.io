---
title: 'Naprej'
description: 'A mobile language-learning app built specifically for English speakers who want to learn Slovenian, featuring structured CEFR-based lessons with 34 units and 600+ vocabulary items.'
category: 'Mobile App'
technologies: ['Swift', 'SwiftUI', 'iOS', 'Android']
image: '/assets/img/naprej-logo.png'
featured: true
status: 'in-progress'
...
Naprej (meaning "forward" in Slovenian) is a mobile language-learning app built specifically for English speakers who want to learn Slovenian. Whether you're planning a trip to Ljubljana, connecting with Slovenian heritage, or simply taking on one of Europe's most unique languages, Naprej gives you a structured, bite-sized path from your very first "Dober dan" to confident everyday conversation.
...
- Travelers heading to Slovenia who want more than a phrasebook
- Heritage speakers reconnecting with family roots
- Language enthusiasts drawn to Slavic languages
- Partners, spouses, or friends of Slovenian speakers
- Students supplementing university coursework
- Anyone curious about a small, beautiful language spoken in the heart of Europe

## The Name

*Naprej* means "forward" in Slovenian. Every lesson is a step forward. Every word you learn opens a door. Naprej.

---

*Naprej is available on iOS and Android. Free to start, with the full A1 and A2 curriculum included.*
